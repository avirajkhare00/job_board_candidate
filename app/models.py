...
class CandidateFields(models.Model):
    ...
    onboarding_step_1_completed = models.BooleanField(default=True)
    onboarding_step_2_completed = models.BooleanField(default=True)
    onboarding_step_3_completed = models.BooleanField(default=True)
