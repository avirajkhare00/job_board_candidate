...
from app.views import register_page, user_onboard, login_user, logout_user
...
from app.api import get_primary_secondary_skills, fetch_indian_city_data, get_indian_cities
urlpatterns = [
