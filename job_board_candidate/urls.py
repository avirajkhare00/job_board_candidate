...
from common_app.views import forget_password_view, forget_password_success_page_view, set_new_password_view
from common_app.views import show_candidate_data
...
urlpatterns = [
    ...
    path('email_sent/', forget_password_success_page_view, name='forget_password_success_page_view'),
    path('new_password/', set_new_password_view, name='set_new_password'),
    path('admin/', admin.site.urls),
    path('', index_page, name='index_page'),
    path('fetch_everything/', fetch_data_for_db),
    path('show_candidate_data/', show_candidate_data, name='show_candidate_data')
]
